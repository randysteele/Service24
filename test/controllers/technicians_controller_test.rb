...
class TechniciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post technicians_url, params: { technician: { address: @technician.address, email: @technician.email, name: @technician.name, phone: @technician.phone, tech_id: @technician.tech_id } }
    end
  ...
  test "should update technician" do
    patch technician_url(@technician), params: { technician: { address: @technician.address, email: @technician.email, name: @technician.name, phone: @technician.phone, tech_id: @technician.tech_id } }
