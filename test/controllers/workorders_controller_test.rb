...
class WorkordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workorder" do
    assert_difference('Workorder.count') do
      post workorders_url, params: { workorder: { PO: @workorder.PO, categorycaller: @workorder.categorycaller, completion_date: @workorder.completion_date, schedule_date: @workorder.schedule_date, work_requested: @workorder.work_requested } }
    end
  ...
  test "should update workorder" do
    patch workorder_url(@workorder), params: { workorder: { PO: @workorder.PO, categorycaller: @workorder.categorycaller, completion_date: @workorder.completion_date, schedule_date: @workorder.schedule_date, work_requested: @workorder.work_requested } }
