class WorkordersController < ApplicationController
  ...
  def index
    @workorders = @client.site.workorders
  end
  ...
  # GET /workorders/new
  def new
    @workorder = @client.sites.workorders.build
  end
  ...
  def create
    @workorder = @client.site.workorders.build(workorder_params)
  ...
  private
    ...
    def workorder_params
      params.require(:workorder).permit(:category, :caller, :PO, :work_requested, :schedule_date, :completion_date)
    end
end
